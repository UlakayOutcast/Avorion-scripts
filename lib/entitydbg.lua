...
function getOmicronValues()
    ...
    omicronValues[1] = {position = 0, value = 30000}
    omicronValues[2] = {position = 160, value = 3219}
    omicronValues[3] = {position = 180, value = 2370}
    omicronValues[4] = {position = 200, value = 1680}
    omicronValues[5] = {position = 220, value = 1032}
    omicronValues[6] = {position = 240, value = 880}
    omicronValues[7] = {position = 260, value = 950}
    omicronValues[8] = {position = 280, value = 660}
    omicronValues[9] = {position = 300, value = 570}
    omicronValues[10] = {position = 320, value = 310}
    omicronValues[11] = {position = 340, value = 270}
    omicronValues[12] = {position = 360, value = 250}
    omicronValues[13] = {position = 380, value = 140}
    omicronValues[14] = {position = 400, value = 130}
