...
function PirateGenerator.createScaledOutlaw(position)
    ...
    return PirateGenerator.create(position, 0.6 * scaling, "Outlaw"%_T)
end

function PirateGenerator.createScaledBandit(position)
    local scaling = PirateGenerator.getScaling()
    return PirateGenerator.create(position, 0.8 * scaling, "Bandit"%_T)
end

function PirateGenerator.createScaledPirate(position)
    local scaling = PirateGenerator.getScaling()
    return PirateGenerator.create(position, 1.2 * scaling, "Pirate"%_T)
end

function PirateGenerator.createScaledMarauder(position)
    local scaling = PirateGenerator.getScaling()
    return PirateGenerator.create(position, 1.5 * scaling, "Marauder"%_T)
end

function PirateGenerator.createScaledDisruptor(position)
    local scaling = PirateGenerator.getScaling()
    return PirateGenerator.create(position, 1.5 * scaling, "Disruptor"%_T)
end
...
function PirateGenerator.createOutlaw(position)
    return PirateGenerator.create(position, 0.6, "Outlaw"%_T)
end

function PirateGenerator.createBandit(position)
    return PirateGenerator.create(position, 0.8, "Bandit"%_T)
end

function PirateGenerator.createPirate(position)
    return PirateGenerator.create(position, 1.2, "Pirate"%_T)
end

function PirateGenerator.createMarauder(position)
    return PirateGenerator.create(position, 1.5, "Marauder"%_T)
end

function PirateGenerator.createDisruptor(position)
    return PirateGenerator.create(position, 1.5, "Disruptor"%_T)
end

function PirateGenerator.createRaider(position)
    return PirateGenerator.create(position, 3.0, "Raider"%_T)
end
