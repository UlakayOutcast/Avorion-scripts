...
function getDescriptionLines(seed, rarity, permanent)
    ...
    table.insert(lines, {ltext = "Trading System"%_t, rtext = "", icon = ""})
    table.insert(lines, {ltext = "Provides economic data"%_t, rtext = "", icon = "data/textures/icons/nothing.png", fontType = FontType.Normal, lcolor = ColorRGB(0.7, 0.7, 0.7)})
