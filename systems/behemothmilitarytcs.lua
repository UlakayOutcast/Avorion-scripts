...
BoostingUpgrades["internal/dlc/rift/systems/interceptorhybrid.lua"] = true
...
function getName(seed, rarity)
    ...
    return "Behemoth Combat Subsystem ${ids}-BTCS-${num}"%_t % {num = turrets + pdcs + autos, ids = ids}
end

function getBasicName()
    return "Behemoth Combat Subsystem /* generic name for 'Behemoth Combat Subsystem ${ids}-BTCS-${num}' */"%_t
end

function getIcon(seed, rarity)
    return "data/textures/icons/behemoth-turret-mtcs.png"
end
...
function getTooltipLines(seed, rarity, permanent)
    ...
    table.insert(bonuses, {ltext = "Armed Turret Slots"%_t, rtext = bonusTurretsStr, icon = "data/textures/icons/turret.png"})
    if pdcs > 0 then
...
function getDescriptionLines(seed, rarity, permanent)
    return {
        ...
        {ltext = "Adds slots for armed turrets"%_t, rtext = "", icon = "data/textures/icons/nothing.png", fontType = FontType.Normal, lcolor = ColorRGB(0.7, 0.7, 0.7)},
        ...
        {ltext = " · " .. "Military Turret Control System"%_t, rtext = "", icon = "data/textures/icons/nothing.png", fontType = FontType.Normal, lcolor = ColorRGB(0.7, 0.7, 0.7)},
